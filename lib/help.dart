...
class ChatScreenState extends State<ChatScreen> {
          ...
          children: [
            Row(
              ...
              children: <Widget>[
                ...
                // Image
                    ? Container(
                  margin: EdgeInsets.only(bottom: isLastMessageRight(index) ? 5 : 10, right: 10),
                  child: OutlinedButton(
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (context) => PhotoView(
                          imageProvider: NetworkImage("${document.get('content')}"),
                        ),
                      );
                    },
        ...
        return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                children: <Widget>[
                  isLastMessageLeft(index)
                    ...
                    child: TextButton(
                      ...
                      style:
                      ButtonStyle(padding: MaterialStateProperty.all<EdgeInsets>(const EdgeInsets.all(0))),
                      child: Material(
              ...
              isLastMessageLeft(index)
                  ? Container(
                margin: const EdgeInsets.only(left: 10, bottom: 16, top: 5, right: 10),
                child: Text(
                  DateFormat('dd MMM kk:mm').format(
                    DateTime.fromMillisecondsSinceEpoch(
                      int.parse(
  ...
  Widget buildSticker() {
    return Expanded(
      child: Container(
        decoration: const BoxDecoration(border: Border(top: BorderSide(color: Colors.red, width: 0.5)), color: Colors.white),
  ...
  Widget buildLoading() {
    return Positioned(
      child: isLoading ? const Center(child: CircularProgressIndicator(color: Colors.grey)) : Container(),
    );
  }
